...
**Agent Intelligence Processing (AIP).** This is the learning system itself — the
...
3. **Run read-only** for an initial period, so you can see exactly how the AI
   ...
   spends money.
4. **Turn on Agent Intelligence Processing (AIP)** and let it start learning from
...
unsupervised. **How it learns** explains the Agent Intelligence Processing (AIP) loop
...
### 4. Let Agent Intelligence Processing (AIP) learn
...
Read Guardrails to expand what the AI can do safely.`,
  ...
  {
    slug: "how-it-learns",
    title: "How it learns (Agent Intelligence Processing / AIP)",
    description: "The observe, learn, verify, deploy loop.",
    category: "Concepts",
    body: `## The Agent Intelligence Processing (AIP) loop
...
Every pattern Agent Intelligence Processing (AIP) drafts — and every rule you or
